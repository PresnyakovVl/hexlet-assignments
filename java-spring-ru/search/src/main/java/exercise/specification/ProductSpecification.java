...
public class ProductSpecification {
    public Specification<Product> build(ProductParamsDTO params) {
        return withProductId(params.getProductId())
    ...
    private Specification<Product> withProductId(Long productId) {
    ...
    private Specification<Product> withRatingGt(Double ratingGt) {
        return (root, query, cb) -> ratingGt == null ? cb.conjunction() : cb.lessThan(root.get("rating"), ratingGt);
    }
